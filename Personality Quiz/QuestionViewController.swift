...
class QuestionViewController: UIViewController {
    ...
    var questions: [Question] = [
        ...
        Question(text: "How many hours do you sleep in a day?",
                 type: .ranged,
                 answers: [
                    Answer(text: "8 hours", type: .dog),
                    Answer(text: "10 hours", type: .rabbit),
                    Answer(text: "15 hours", type: .turtle),
                    Answer(text: "18 hours", type: .cat)
